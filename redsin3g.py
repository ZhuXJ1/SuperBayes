...
outdir = '/fred/oz008/xzhu/projects/SuperBayes/PG1302_2020/redsin_gamma'
if not os.path.exists(outdir):
    os.makedirs(outdir)
label = 'redsin_gamma_CALp1'
...
priors['logCC'] = bilby.core.prior.Uniform(-5, 0, name='logCC', latex_label='$\\ln \\hat{\\sigma}^2$ [mag$^2$ yr$^{-1}$]')
priors['logTAU0'] = bilby.core.prior.Uniform(-2, 2, name='logTAU0', latex_label='$\\ln \\tau_{0}$ [yr]')
